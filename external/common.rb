...
if CONFIG['arch'] =~ /mswin/
    ...
    # rename patch to ptch to avoid UAC on vista
...
# Patches should be created from within top level dir via
#   ..\WinTools\bin\diff -PNaur dir/file.orig dir/file > xxx_{win32|osx|all}.patch
#
